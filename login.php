...
<head>
	...
	<?php
    $con = new mysqli('localhost','root','Jatin@123','mybank');
    define('bankName', 'GMD Bank',true);
...
<body style="background: url(images/login2.jpg);background-size: 100%">
<h1 class="alert alert-success rounded-0"> <img src="images/logo.png" width="85" height="85" class="d-inline-block align-top" alt="">
<?php echo bankname; ?><small class="float-right text-muted" style="font-size: 12pt;"><kbd>Presented by: Jatin Chaudhari, Saujas Chitnis, Prathamesh Chaudhari, Deepak Chavan</kbd></small>
...
<div id="accordion" role="tablist" class="w-25 float-right shadowBlack" style="margin-right: 222px">
	<br><h4 class="text-center text-green">Select Your Session</h4>
    ...
    <div class="card-header" role="tab" id="headingOne">
      <h5 class="mb-0">
        <a style="text-decoration: none;" data-toggle="collapse" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
         <button class="btn btn-outline-success btn-block">Login(For User)</button>
        </a>
      </h5>
    </div>
